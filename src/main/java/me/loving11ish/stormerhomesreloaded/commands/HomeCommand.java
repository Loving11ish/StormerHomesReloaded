...
public class HomeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String alias, String[] args) {
        if(sender instanceof Player) {
            ...
            if(cmd.getName().equalsIgnoreCase("homes")) {
                ...
                int maxHomes = p.isOp() ? StormerHomesReloaded.i.getConfig().getInt("maxOpHomes") : StormerHomesReloaded.i.getConfig().getInt("maxHomes");
                ...
                if(option.equalsIgnoreCase("config")) {
                    ...
                    if(type.equalsIgnoreCase("show")) {
                        Message.normal(p, StormerHomesReloaded.i.getConfig().saveToString());
                        return true;
                    }
                    if(type.equalsIgnoreCase("edit")) {
                        ...
                        if(edit.equalsIgnoreCase("get")) {
                            Message.normal(p, StormerHomesReloaded.i.getConfig().getString(path));
                            return true;
                        }
                        if(edit.equalsIgnoreCase("set")) {
                            ...
                            StormerHomesReloaded.i.getConfig().set(path, args[4]);
                            return true;
                        }
                        ...
                        if(edit.equalsIgnoreCase("list")) {
                            ...
                            for(String key : StormerHomesReloaded.i.getConfig().getConfigurationSection(path).getKeys(false)) Message.normal(p, key);
                            return true;
                        }
                        Message.error(p, "options : get-set-unset");
                        return false;
    ...
    private static boolean isSuperAdmin(Player p){
        return p.isOp();
    }
